        ...
        <section className={`${styles.hero} text-white body-font`}>
            <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
                    <Image alt="hero" src="https://telegra.ph/file/043281968ac9ae73a92e7.png" className="object-cover object-center rounded" layout="responsive" width={1000} height={600} />
                </div>
                <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                    ...
                    <div className="flex lg:flex-row md:flex-col">
                        <button type="button" className="bg-gray-100 inline-flex py-3 px-8 rounded-lg items-center hover:bg-gray-200 focus:outline-none">
                            <Image src="https://telegra.ph/file/d21d01e9df13a5adf388c.png" width={35} height={35} layout='responsive' alt="Try now" />
