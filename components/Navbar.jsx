  ...
  const NavLink = ({ text, url }) => (
    <>
      <Link href={url}>
        <a
          onClick={handleClick}
          className="mx-2 lg:inline-flex lg:w-auto w-full px-3 py-2 rounded text-white font-bold items-center justify-center hover:bg-green-600 hover:text-white "
        >
          {text}
        </a>
      </Link>
  ...
  return (
    <>
      <section
        ...
        className={
          styles.nav +
          " flex items-center flex-wrap p-3 transition duration-1000"
        }
      >
        <Link href="/">
